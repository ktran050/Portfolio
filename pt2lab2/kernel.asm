...
80103bab:	c7 04 24 9d 74 10 80 	movl   $0x8010749d,(%esp)
80103bb2:	e8 a9 c7 ff ff       	call   80100360 <panic>
80103bb7:	c7 04 24 90 74 10 80 	movl   $0x80107490,(%esp)
...
80103c9c:	5d                   	pop    %ebp
80103c9d:	c3                   	ret    
80103c9e:	c7 04 24 af 74 10 80 	movl   $0x801074af,(%esp)
80103ca5:	e8 b6 c6 ff ff       	call   80100360 <panic>
80103caa:	c7 04 24 a9 74 10 80 	movl   $0x801074a9,(%esp)
...
80103e98:	c7 04 24 3f 78 10 80 	movl   $0x8010783f,(%esp)
...
80103ebd:	ba c0 74 10 80       	mov    $0x801074c0,%edx
80103ec2:	77 11                	ja     80103ed5 <procdump+0x55>
80103ec4:	8b 14 85 20 75 10 80 	mov    -0x7fef8ae0(,%eax,4),%edx
80103ecb:	b8 c0 74 10 80       	mov    $0x801074c0,%eax
...
80103ee0:	c7 04 24 c4 74 10 80 	movl   $0x801074c4,(%esp)
...
80103f29:	c7 04 24 01 6f 10 80 	movl   $0x80106f01,(%esp)
...
80103f5a:	c7 44 24 04 38 75 10 	movl   $0x80107538,0x4(%esp)
80103f61:	80 
...
801041b9:	c7 04 24 43 75 10 80 	movl   $0x80107543,(%esp)
...
80104218:	c9                   	leave  
80104219:	c3                   	ret    
8010421a:	c7 04 24 62 75 10 80 	movl   $0x80107562,(%esp)
80104221:	e8 3a c1 ff ff       	call   80100360 <panic>
80104226:	c7 04 24 4b 75 10 80 	movl   $0x8010754b,(%esp)
...
80104251:	c7 04 24 69 75 10 80 	movl   $0x80107569,(%esp)
...
8010466d:	8b 14 85 a0 75 10 80 	mov    -0x7fef8a60(,%eax,4),%edx
...
80104696:	c7 04 24 71 75 10 80 	movl   $0x80107571,(%esp)
...
80104820:	c7 44 24 04 1c 76 10 	movl   $0x8010761c,0x4(%esp)
80104827:	80 
...
8010483b:	c7 44 24 04 1b 76 10 	movl   $0x8010761b,0x4(%esp)
80104842:	80 
...
80104853:	c7 04 24 0f 76 10 80 	movl   $0x8010760f,(%esp)
8010485a:	e8 01 bb ff ff       	call   80100360 <panic>
8010485f:	c7 04 24 1e 76 10 80 	movl   $0x8010761e,(%esp)
80104866:	e8 f5 ba ff ff       	call   80100360 <panic>
8010486b:	c7 04 24 00 76 10 80 	movl   $0x80107600,(%esp)
...
80104c11:	c7 44 24 04 1c 76 10 	movl   $0x8010761c,0x4(%esp)
80104c18:	80 
...
80104c29:	c7 44 24 04 1b 76 10 	movl   $0x8010761b,0x4(%esp)
80104c30:	80 
...
80104d7d:	c7 04 24 40 76 10 80 	movl   $0x80107640,(%esp)
80104d84:	e8 d7 b5 ff ff       	call   80100360 <panic>
80104d89:	c7 04 24 52 76 10 80 	movl   $0x80107652,(%esp)
80104d90:	e8 cb b5 ff ff       	call   80100360 <panic>
80104d95:	c7 04 24 2e 76 10 80 	movl   $0x8010762e,(%esp)
...
801054c9:	c7 44 24 04 61 76 10 	movl   $0x80107661,0x4(%esp)
801054d0:	80 
...
80105560:	ff 24 85 08 77 10 80 	jmp    *-0x7fef88f8(,%eax,4)
80105567:	90                   	nop
...
801055d3:	c7 04 24 c4 76 10 80 	movl   $0x801076c4,(%esp)
...
801056cc:	c7 04 24 6c 76 10 80 	movl   $0x8010766c,(%esp)
...
8010578a:	c7 04 24 90 76 10 80 	movl   $0x80107690,(%esp)
80105791:	89 44 24 04          	mov    %eax,0x4(%esp)
80105795:	e8 b6 ae ff ff       	call   80100650 <cprintf>
8010579a:	c7 04 24 66 76 10 80 	movl   $0x80107666,(%esp)
...
80105897:	00 
80105898:	bb 88 77 10 80       	mov    $0x80107788,%ebx
...
80106479:	5d                   	pop    %ebp
8010647a:	c3                   	ret    
8010647b:	c7 04 24 26 71 10 80 	movl   $0x80107126,(%esp)
...
801065c0:	5d                   	pop    %ebp
801065c1:	c3                   	ret    
801065c2:	c7 04 24 90 77 10 80 	movl   $0x80107790,(%esp)
...
801066d1:	c7 04 24 96 77 10 80 	movl   $0x80107796,(%esp)
801066d8:	e8 83 9c ff ff       	call   80100360 <panic>
801066dd:	c7 04 24 c1 77 10 80 	movl   $0x801077c1,(%esp)
801066e4:	e8 77 9c ff ff       	call   80100360 <panic>
801066e9:	c7 04 24 ac 77 10 80 	movl   $0x801077ac,(%esp)
...
8010677e:	c7 04 24 d5 77 10 80 	movl   $0x801077d5,(%esp)
...
80106830:	5d                   	pop    %ebp
80106831:	c3                   	ret    
80106832:	c7 04 24 ef 77 10 80 	movl   $0x801077ef,(%esp)
80106839:	e8 22 9b ff ff       	call   80100360 <panic>
8010683e:	c7 04 24 90 78 10 80 	movl   $0x80107890,(%esp)
...
801068e2:	c7 04 24 0d 78 10 80 	movl   $0x8010780d,(%esp)
...
80106910:	c7 04 24 25 78 10 80 	movl   $0x80107825,(%esp)
...
801069d8:	c7 04 24 41 78 10 80 	movl   $0x80107841,(%esp)
...
80106aba:	c9                   	leave  
80106abb:	c3                   	ret    
80106abc:	c7 04 24 52 78 10 80 	movl   $0x80107852,(%esp)
...
80106ba7:	c7 04 24 76 78 10 80 	movl   $0x80107876,(%esp)
80106bae:	e8 ad 97 ff ff       	call   80100360 <panic>
80106bb3:	c7 04 24 5c 78 10 80 	movl   $0x8010785c,(%esp)
...
80106c96:	c7 44 24 04 b4 78 10 	movl   $0x801078b4,0x4(%esp)
80106c9d:	80 
...
80106cfc:	e8 af c9 ff ff       	call   801036b0 <myproc>
  char *mem;
  int i;
...
int shm_open(int id, char **pointer) {
  uint pageSeen=0;	// flag that an id has been seen
  struct proc *curproc=myproc();
80106d08:	89 c6                	mov    %eax,%esi
  char *mem;
  int i;

  // Loop through the table
  acquire(&(shm_table.lock));
80106d0a:	e8 41 d4 ff ff       	call   80104150 <acquire>
80106d0f:	b9 f4 54 11 80       	mov    $0x801154f4,%ecx
  for(i = 0; i < 64; i++){
...
80106d23:	39 19                	cmp    %ebx,(%ecx)
80106d25:	75 f1                	jne    80106d18 <shm_open+0x28>
      // Set flag
      pageSeen=1;
      // Increment counter
      shm_table.shm_pages[i].refcnt++;
80106d27:	8d 04 52             	lea    (%edx,%edx,2),%eax
80106d2a:	c1 e0 02             	shl    $0x2,%eax
80106d2d:	83 80 fc 54 11 80 01 	addl   $0x1,-0x7feeab04(%eax)
      // Map the page
      mem=shm_table.shm_pages[i].frame;
      mappages(curproc->pgdir, (void *)(PGROUNDUP(curproc->sz)), PGSIZE, V2P(mem), PTE_W|PTE_U);
80106d34:	8b 80 f8 54 11 80    	mov    -0x7feeab08(%eax),%eax
80106d3a:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106d41:	00 
80106d42:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106d49:	00 
80106d4a:	05 00 00 00 80       	add    $0x80000000,%eax
80106d4f:	89 44 24 0c          	mov    %eax,0xc(%esp)
80106d53:	8b 06                	mov    (%esi),%eax
80106d55:	05 ff 0f 00 00       	add    $0xfff,%eax
80106d5a:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106d5f:	89 44 24 04          	mov    %eax,0x4(%esp)
80106d63:	8b 46 04             	mov    0x4(%esi),%eax
80106d66:	89 04 24             	mov    %eax,(%esp)
80106d69:	e8 e2 f7 ff ff       	call   80106550 <mappages>
      // Return pointer to virtual address
      *pointer=(char *)(curproc->sz);
80106d6e:	8b 06                	mov    (%esi),%eax
80106d70:	8b 7d 0c             	mov    0xc(%ebp),%edi
80106d73:	89 07                	mov    %eax,(%edi)
...
80106db1:	0f 84 83 00 00 00    	je     80106e3a <shm_open+0x14a>
...
80106dd5:	00 
80106dd6:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106ddd:	00 
    for(i=0; i < 64; i++){
      if(shm_table.shm_pages[i].id==0){
        // Set id
...
80106de3:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
	...
	mem=kalloc();
        // Set frame
        shm_table.shm_pages[i].frame=mem;
80106de9:	89 87 f8 54 11 80    	mov    %eax,-0x7feeab08(%edi)
        memset(shm_table.shm_pages[i].frame, 0, PGSIZE);
80106def:	e8 9c d4 ff ff       	call   80104290 <memset>
        // Increment page count
        shm_table.shm_pages[i].refcnt=1;
80106df4:	c7 87 fc 54 11 80 01 	movl   $0x1,-0x7feeab04(%edi)
80106dfb:	00 00 00 
        // Map the page
        mappages(curproc->pgdir, (void *)(PGROUNDUP(curproc->sz)), PGSIZE, V2P(mem), PTE_W|PTE_U);
80106dfe:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106e05:	00 
80106e06:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
80106e0a:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106e11:	00 
80106e12:	8b 06                	mov    (%esi),%eax
80106e14:	05 ff 0f 00 00       	add    $0xfff,%eax
80106e19:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106e1e:	89 44 24 04          	mov    %eax,0x4(%esp)
80106e22:	8b 46 04             	mov    0x4(%esi),%eax
80106e25:	89 04 24             	mov    %eax,(%esp)
80106e28:	e8 23 f7 ff ff       	call   80106550 <mappages>
        // Return pointer to virtual address
        *pointer=(char *)(curproc->sz);
80106e2d:	8b 06                	mov    (%esi),%eax
80106e2f:	8b 7d 0c             	mov    0xc(%ebp),%edi
80106e32:	89 07                	mov    %eax,(%edi)
        // Increment the size
        curproc->sz+=PGSIZE;
80106e34:	81 06 00 10 00 00    	addl   $0x1000,(%esi)
        break;
      }
    }
  }
...
80106e41:	e8 fa d3 ff ff       	call   80104240 <release>
  return 0; //added to remove compiler warning -- you should decide what to return
}
80106e46:	83 c4 2c             	add    $0x2c,%esp
...
80106e66:	b8 f4 54 11 80       	mov    $0x801154f4,%eax
80106e6b:	eb 0d                	jmp    80106e7a <shm_close+0x2a>
80106e6d:	8d 76 00             	lea    0x0(%esi),%esi
80106e70:	83 c0 0c             	add    $0xc,%eax
  // Loop through the table looking for the id
  for(i=0; i <64; i++){
80106e73:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80106e78:	74 2e                	je     80106ea8 <shm_close+0x58>
    if(shm_table.shm_pages[i].id==id){
80106e7a:	3b 18                	cmp    (%eax),%ebx
80106e7c:	75 f2                	jne    80106e70 <shm_close+0x20>
      // Decrease reference count
      shm_table.shm_pages[i].refcnt--;
80106e7e:	8b 48 08             	mov    0x8(%eax),%ecx
80106e81:	8d 51 ff             	lea    -0x1(%ecx),%edx
      // if refcnt is now empty clear the entry
      if(shm_table.shm_pages[i].refcnt==0){
80106e84:	85 d2                	test   %edx,%edx
  acquire(&(shm_table.lock));
  // Loop through the table looking for the id
  for(i=0; i <64; i++){
    if(shm_table.shm_pages[i].id==id){
      // Decrease reference count
      shm_table.shm_pages[i].refcnt--;
80106e86:	89 50 08             	mov    %edx,0x8(%eax)
      // if refcnt is now empty clear the entry
      if(shm_table.shm_pages[i].refcnt==0){
80106e89:	75 e5                	jne    80106e70 <shm_close+0x20>
        shm_table.shm_pages[i].id=0;
80106e8b:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80106e91:	83 c0 0c             	add    $0xc,%eax
        shm_table.shm_pages[i].frame=0;	// refcount is already 0; no need to set it again
80106e94:	c7 40 f8 00 00 00 00 	movl   $0x0,-0x8(%eax)
int shm_close(int id) {
  int i;
  ...
  // Loop through the table looking for the id
  for(i=0; i <64; i++){
80106e9b:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80106ea0:	75 d8                	jne    80106e7a <shm_close+0x2a>
