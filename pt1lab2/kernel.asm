...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 df 76 10 80 	movl   $0x801076df,(%esp)
...
80100b4b:	c7 44 24 08 fb ff ff 	movl   $0x7ffffffb,0x8(%esp)
80100b52:	7f 
...
80100b78:	0f 84 93 01 00 00    	je     80100d11 <exec+0x371>
80100b7e:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80100b81:	31 d2                	xor    %edx,%edx
80100b83:	bb fc ff ff 7f       	mov    $0x7ffffffc,%ebx
...
80100bc7:	e8 c4 38 00 00       	call   80104490 <strlen>
...
80100bd8:	e8 b3 38 00 00       	call   80104490 <strlen>
...
80100bf7:	e8 54 60 00 00       	call   80106c50 <copyout>
...
80100c09:	e8 e2 5c 00 00       	call   801068f0 <freevm>
  if(ip){
    iunlockput(ip);
    end_op();
  }
...
80100c18:	e8 53 1f 00 00       	call   80102b70 <end_op>
    cprintf("exec: fail\n");
80100c1d:	c7 04 24 e1 6d 10 80 	movl   $0x80106de1,(%esp)
...
80100c75:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  ...
  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c7b:	e8 d0 5f 00 00       	call   80106c50 <copyout>
...
80100cc8:	e8 83 37 00 00       	call   80104450 <safestrcpy>
...
80100cd6:	8b 47 18             	mov    0x18(%edi),%eax
  ...
  // Set the default stacksize
  curproc->stacksz=1;
80100cd9:	c7 47 7c 01 00 00 00 	movl   $0x1,0x7c(%edi)

  // Commit to the user image.
  oldpgdir = curproc->pgdir;
  curproc->pgdir = pgdir;
80100ce0:	89 4f 04             	mov    %ecx,0x4(%edi)
  curproc->sz = sz;
80100ce3:	8b 8d e8 fe ff ff    	mov    -0x118(%ebp),%ecx
80100ce9:	89 0f                	mov    %ecx,(%edi)
  curproc->tf->eip = elf.entry;  // main
80100ceb:	8b 95 3c ff ff ff    	mov    -0xc4(%ebp),%edx
80100cf1:	89 50 38             	mov    %edx,0x38(%eax)
  curproc->tf->esp = sp;
80100cf4:	8b 47 18             	mov    0x18(%edi),%eax
80100cf7:	89 58 44             	mov    %ebx,0x44(%eax)
  switchuvm(curproc);
80100cfa:	89 3c 24             	mov    %edi,(%esp)
80100cfd:	e8 6e 58 00 00       	call   80106570 <switchuvm>
  freevm(oldpgdir);
80100d02:	89 34 24             	mov    %esi,(%esp)
80100d05:	e8 e6 5b 00 00       	call   801068f0 <freevm>
  return 0;
80100d0a:	31 c0                	xor    %eax,%eax
80100d0c:	e9 01 fd ff ff       	jmp    80100a12 <exec+0x72>
    goto bad;
//  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));  unncessary now
  sp = KERNBASE-4;
  ...
  // Push argument strings, prepare rest of stack in ustack.
  for(argc = 0; argv[argc]; argc++) {
80100d11:	bb fc ff ff 7f       	mov    $0x7ffffffc,%ebx
80100d16:	31 d2                	xor    %edx,%edx
80100d18:	8d 8d 58 ff ff ff    	lea    -0xa8(%ebp),%ecx
80100d1e:	e9 12 ff ff ff       	jmp    80100c35 <exec+0x295>
...
80100d36:	c7 44 24 04 ed 6d 10 	movl   $0x80106ded,0x4(%esp)
80100d3d:	80 
...
filedup(struct file *f)
{
  ...
  if(f->ref < 1)
    panic("filedup");
80100df7:	c7 04 24 f4 6d 10 80 	movl   $0x80106df4,(%esp)
...
80100eb7:	e9 b4 1c 00 00       	jmp    80102b70 <end_op>
{
  ...
  if(f->ref < 1)
    panic("fileclose");
80100ebc:	c7 04 24 fc 6d 10 80 	movl   $0x80106dfc,(%esp)
...
80100fa5:	eb d8                	jmp    80100f7f <fileread+0x5f>
  ...
  panic("fileread");
80100fa7:	c7 04 24 06 6e 10 80 	movl   $0x80106e06,(%esp)
...
801010bc:	e9 1f 22 00 00       	jmp    801032e0 <pipewrite>
      ...
      if(r != n1)
        panic("short filewrite");
801010c1:	c7 04 24 0f 6e 10 80 	movl   $0x80106e0f,(%esp)
801010c8:	e8 93 f2 ff ff       	call   80100360 <panic>
  ...
  panic("filewrite");
801010cd:	c7 04 24 15 6e 10 80 	movl   $0x80106e15,(%esp)
...
80101185:	c7 04 24 1f 6e 10 80 	movl   $0x80106e1f,(%esp)
...
801012ac:	c3                   	ret    
  ...
  if(empty == 0)
    panic("iget: no inodes");
801012ad:	c7 04 24 35 6e 10 80 	movl   $0x80106e35,(%esp)
...
80101365:	eb 93                	jmp    801012fa <bmap+0x3a>
  ...
  panic("bmap: out of range");
80101367:	c7 04 24 45 6e 10 80 	movl   $0x80106e45,(%esp)
...
80101448:	c3                   	ret    
  ...
  if((bp->data[bi/8] & m) == 0)
    panic("freeing free block");
80101449:	c7 04 24 58 6e 10 80 	movl   $0x80106e58,(%esp)
...
8010146c:	c7 44 24 04 6b 6e 10 	movl   $0x80106e6b,0x4(%esp)
80101473:	80 
...
80101489:	c7 44 24 04 72 6e 10 	movl   $0x80106e72,0x4(%esp)
80101490:	80 
...
801014b6:	c7 04 24 d8 6e 10 80 	movl   $0x80106ed8,(%esp)
...
801015cc:	e9 2f fc ff ff       	jmp    80101200 <iget>
  ...
  panic("ialloc: no inodes");
801015d1:	c7 04 24 78 6e 10 80 	movl   $0x80106e78,(%esp)
...
80101754:	0f 85 76 ff ff ff    	jne    801016d0 <ilock+0x30>
      panic("ilock: no type");
8010175a:	c7 04 24 90 6e 10 80 	movl   $0x80106e90,(%esp)
80101761:	e8 fa eb ff ff       	call   80100360 <panic>
{
  ...
  if(ip == 0 || ip->ref < 1)
    panic("ilock");
80101766:	c7 04 24 8a 6e 10 80 	movl   $0x80106e8a,(%esp)
...
iunlock(struct inode *ip)
{
  if(ip == 0 || !holdingsleep(&ip->lock) || ip->ref < 1)
    panic("iunlock");
801017b3:	c7 04 24 9f 6e 10 80 	movl   $0x80106e9f,(%esp)
...
80101c51:	c3                   	ret    
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlookup read");
80101c52:	c7 04 24 b9 6e 10 80 	movl   $0x80106eb9,(%esp)
80101c59:	e8 02 e7 ff ff       	call   80100360 <panic>
{
  ...
  if(dp->type != T_DIR)
    panic("dirlookup not DIR");
80101c5e:	c7 04 24 a7 6e 10 80 	movl   $0x80106ea7,(%esp)
...
80101ed3:	eb e9                	jmp    80101ebe <dirlink+0xae>
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlink read");
80101ed5:	c7 04 24 c8 6e 10 80 	movl   $0x80106ec8,(%esp)
80101edc:	e8 7f e4 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("dirlink");
80101ee1:	c7 04 24 c6 74 10 80 	movl   $0x801074c6,(%esp)
...
80101fcf:	c7 04 24 34 6f 10 80 	movl   $0x80106f34,(%esp)
...
idestart(struct buf *b)
{
  if(b == 0)
    panic("idestart");
80101fdb:	c7 04 24 2b 6f 10 80 	movl   $0x80106f2b,(%esp)
...
80101ff6:	c7 44 24 04 46 6f 10 	movl   $0x80106f46,0x4(%esp)
80101ffd:	80 
...
iderw(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    panic("iderw: buf not locked");
801021cb:	c7 04 24 4a 6f 10 80 	movl   $0x80106f4a,(%esp)
801021d2:	e8 89 e1 ff ff       	call   80100360 <panic>
  if((b->flags & (B_VALID|B_DIRTY)) == B_VALID)
    panic("iderw: nothing to do");
  if(b->dev != 0 && !havedisk1)
    panic("iderw: ide disk 1 not present");
801021d7:	c7 04 24 75 6f 10 80 	movl   $0x80106f75,(%esp)
801021de:	e8 7d e1 ff ff       	call   80100360 <panic>
  ...
  if((b->flags & (B_VALID|B_DIRTY)) == B_VALID)
    panic("iderw: nothing to do");
801021e3:	c7 04 24 60 6f 10 80 	movl   $0x80106f60,(%esp)
...
80102238:	c7 04 24 94 6f 10 80 	movl   $0x80106f94,(%esp)
...
kfree(char *v)
{
  ...
  if((uint)v % PGSIZE || v < end || V2P(v) >= PHYSTOP)
    panic("kfree");
8010236e:	c7 04 24 c6 6f 10 80 	movl   $0x80106fc6,(%esp)
...
801023db:	c7 44 24 04 cc 6f 10 	movl   $0x80106fcc,0x4(%esp)
801023e2:	80 
...
80102a6b:	c7 44 24 04 00 72 10 	movl   $0x80107200,0x4(%esp)
80102a72:	80 
...
80102c92:	c3                   	ret    
  ...
  if(log.committing)
    panic("log.committing");
80102c93:	c7 04 24 04 72 10 80 	movl   $0x80107204,(%esp)
...
log_write(struct buf *b)
{
  ...
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
    panic("too big a transaction");
80102d50:	c7 04 24 13 72 10 80 	movl   $0x80107213,(%esp)
80102d57:	e8 04 d6 ff ff       	call   80100360 <panic>
  if (log.outstanding < 1)
    panic("log_write outside of trans");
80102d5c:	c7 04 24 29 72 10 80 	movl   $0x80107229,(%esp)
...
80102d87:	c7 04 24 44 72 10 80 	movl   $0x80107244,(%esp)
...
80102e03:	e8 f8 3b 00 00       	call   80106a00 <kvmalloc>
...
80102e35:	e8 a6 3e 00 00       	call   80106ce0 <shminit>
  tvinit();        // trap vectors
...
80102f2f:	00 
80102f30:	c7 44 24 04 58 72 10 	movl   $0x80107258,0x4(%esp)
80102f37:	80 
...
80102fea:	00 
80102feb:	c7 44 24 04 5d 72 10 	movl   $0x8010725d,0x4(%esp)
80102ff2:	80 
...
8010307c:	ff 24 8d 9c 72 10 80 	jmp    *-0x7fef8d64(,%ecx,4)
80103083:	90                   	nop
...
80103107:	0f 85 c5 fe ff ff    	jne    80102fd2 <mpinit+0x52>
  ...
  if((conf = mpconfig(&mp)) == 0)
    panic("Expect to run on an SMP");
8010310d:	c7 04 24 62 72 10 80 	movl   $0x80107262,(%esp)
...
80103128:	eb e3                	jmp    8010310d <mpinit+0x18d>
  ...
  if(!ismp)
    panic("Didn't find a suitable machine");
8010312a:	c7 04 24 7c 72 10 80 	movl   $0x8010727c,(%esp)
...
801031cf:	c7 44 24 04 b0 72 10 	movl   $0x801072b0,0x4(%esp)
801031d6:	80 
...
801035d6:	c7 44 24 04 b5 72 10 	movl   $0x801072b5,0x4(%esp)
801035dd:	80 
...
80103648:	eb ea                	jmp    80103634 <mycpu+0x44>
  ...
  panic("unknown apicid\n");
8010364a:	c7 04 24 bc 72 10 80 	movl   $0x801072bc,(%esp)
...
mycpu(void)
{
  ...
  if(readeflags()&FL_IF)
    panic("mycpu called with interrupts enabled\n");
80103656:	c7 04 24 98 73 10 80 	movl   $0x80107398,(%esp)
...
801036d3:	e8 98 32 00 00       	call   80106970 <setupkvm>
...
80103772:	00 
80103773:	c7 44 24 04 e5 72 10 	movl   $0x801072e5,0x4(%esp)
8010377a:	80 
8010377b:	89 04 24             	mov    %eax,(%esp)
8010377e:	e8 cd 0c 00 00       	call   80104450 <safestrcpy>
  p->cwd = namei("/");
80103783:	c7 04 24 ee 72 10 80 	movl   $0x801072ee,(%esp)
...
801037b6:	c3                   	ret    
  ...
  if((p->pgdir = setupkvm()) == 0)
    panic("userinit: out of memory?");
801037b7:	c7 04 24 cc 72 10 80 	movl   $0x801072cc,(%esp)
...
8010382a:	e8 a1 30 00 00       	call   801068d0 <deallocuvm>
...
8010386e:	e8 dd 31 00 00       	call   80106a50 <copyuvm>
...
80103a5d:	c3                   	ret    
{
  ...
  if(!holding(&ptable.lock))
    panic("sched ptable.lock");
80103a5e:	c7 04 24 f0 72 10 80 	movl   $0x801072f0,(%esp)
80103a65:	e8 f6 c8 ff ff       	call   80100360 <panic>
  ...
  if(readeflags()&FL_IF)
    panic("sched interruptible");
80103a6a:	c7 04 24 1c 73 10 80 	movl   $0x8010731c,(%esp)
80103a71:	e8 ea c8 ff ff       	call   80100360 <panic>
  ...
  if(p->state == RUNNING)
    panic("sched running");
80103a76:	c7 04 24 0e 73 10 80 	movl   $0x8010730e,(%esp)
80103a7d:	e8 de c8 ff ff       	call   80100360 <panic>
  ...
  if(mycpu()->ncli != 1)
    panic("sched locks");
80103a82:	c7 04 24 02 73 10 80 	movl   $0x80107302,(%esp)
...
80103b86:	e8 65 fe ff ff       	call   801039f0 <sched>
  panic("zombie exit");
80103b8b:	c7 04 24 3d 73 10 80 	movl   $0x8010733d,(%esp)
80103b92:	e8 c9 c7 ff ff       	call   80100360 <panic>
  ...
  if(curproc == initproc)
    panic("init exiting");
80103b97:	c7 04 24 30 73 10 80 	movl   $0x80107330,(%esp)
...
80103c7e:	c7 04 24 4f 73 10 80 	movl   $0x8010734f,(%esp)
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  if(p == 0)
    panic("sleep");
80103c8a:	c7 04 24 49 73 10 80 	movl   $0x80107349,(%esp)
...
80103d28:	e8 c3 2b 00 00       	call   801068f0 <freevm>
        p->pid = 0;
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
...
80103e74:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e78:	c7 04 24 df 76 10 80 	movl   $0x801076df,(%esp)
...
80103e9a:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
80103e9d:	ba 60 73 10 80       	mov    $0x80107360,%edx
  uint pc[10];
...
80103ea4:	8b 14 85 c0 73 10 80 	mov    -0x7fef8c40(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
80103eab:	b8 60 73 10 80       	mov    $0x80107360,%eax
...
80103ec0:	c7 04 24 64 73 10 80 	movl   $0x80107364,(%esp)
...
80103f09:	c7 04 24 a1 6d 10 80 	movl   $0x80106da1,(%esp)
...
80103f3a:	c7 44 24 04 d8 73 10 	movl   $0x801073d8,0x4(%esp)
80103f41:	80 
...
80104197:	eb ac                	jmp    80104145 <acquire+0x15>
    panic("acquire");
80104199:	c7 04 24 e3 73 10 80 	movl   $0x801073e3,(%esp)
...
popcli(void)
{
  ...
  if(--mycpu()->ncli < 0)
    panic("popcli");
801041fa:	c7 04 24 02 74 10 80 	movl   $0x80107402,(%esp)
...
popcli(void)
{
  if(readeflags()&FL_IF)
    panic("popcli - interruptible");
80104206:	c7 04 24 eb 73 10 80 	movl   $0x801073eb,(%esp)
...
release(struct spinlock *lk)
{
  if(!holding(lk))
    panic("release");
80104231:	c7 04 24 09 74 10 80 	movl   $0x80107409,(%esp)
...
//  if(addr >= KERNBASE-curproc->sz || addr+4 < curproc->sz)
//     return -1;
  *ip = *(int*)(addr);
...
801045ed:	8b 14 85 40 74 10 80 	mov    -0x7fef8bc0(,%eax,4),%edx
...
80104616:	c7 04 24 11 74 10 80 	movl   $0x80107411,(%esp)
...
801047a0:	c7 44 24 04 bc 74 10 	movl   $0x801074bc,0x4(%esp)
801047a7:	80 
...
801047bb:	c7 44 24 04 bb 74 10 	movl   $0x801074bb,0x4(%esp)
801047c2:	80 
...
801047d1:	79 89                	jns    8010475c <create+0xdc>
      panic("create dots");
801047d3:	c7 04 24 af 74 10 80 	movl   $0x801074af,(%esp)
801047da:	e8 81 bb ff ff       	call   80100360 <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
    panic("create: dirlink");
801047df:	c7 04 24 be 74 10 80 	movl   $0x801074be,(%esp)
801047e6:	e8 75 bb ff ff       	call   80100360 <panic>
  ...
  if((ip = ialloc(dp->dev, type)) == 0)
    panic("create: ialloc");
801047eb:	c7 04 24 a0 74 10 80 	movl   $0x801074a0,(%esp)
...
80104b91:	c7 44 24 04 bc 74 10 	movl   $0x801074bc,0x4(%esp)
80104b98:	80 
...
80104ba9:	c7 44 24 04 bb 74 10 	movl   $0x801074bb,0x4(%esp)
80104bb0:	80 
...
80104cf8:	e9 48 ff ff ff       	jmp    80104c45 <sys_unlink+0x105>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
80104cfd:	c7 04 24 e0 74 10 80 	movl   $0x801074e0,(%esp)
80104d04:	e8 57 b6 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("unlink: writei");
80104d09:	c7 04 24 f2 74 10 80 	movl   $0x801074f2,(%esp)
80104d10:	e8 4b b6 ff ff       	call   80100360 <panic>
  ...
  if(ip->nlink < 1)
    panic("unlink: nlink < 1");
80104d15:	c7 04 24 ce 74 10 80 	movl   $0x801074ce,(%esp)
...
801051c9:	e8 72 1b 00 00       	call   80106d40 <shm_open>
}
801051ce:	c9                   	leave  
801051cf:	c3                   	ret    
int sys_shm_open(void) {
...
80105203:	e8 48 1b 00 00       	call   80106d50 <shm_close>
}
80105208:	c9                   	leave  
80105209:	c3                   	ret    
...
80105449:	c7 44 24 04 01 75 10 	movl   $0x80107501,0x4(%esp)
80105450:	80 
...
801054e0:	ff 24 85 a8 75 10 80 	jmp    *-0x7fef8a58(,%eax,4)
801054e7:	90                   	nop
    lapiceoi();
    break;
...
80105553:	c7 04 24 64 75 10 80 	movl   $0x80107564,(%esp)
...
8010564c:	c7 04 24 0c 75 10 80 	movl   $0x8010750c,(%esp)
...
8010570a:	c7 04 24 30 75 10 80 	movl   $0x80107530,(%esp)
80105711:	89 44 24 04          	mov    %eax,0x4(%esp)
80105715:	e8 36 af ff ff       	call   80100650 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
8010571a:	c7 04 24 06 75 10 80 	movl   $0x80107506,(%esp)
...
80105817:	00 
  ...
  for(p="xv6...\n"; *p; p++)
80105818:	bb 28 76 10 80       	mov    $0x80107628,%ebx
...
801063fa:	c3                   	ret    
    if(!pte)
      ...
      if(pa == 0)
        panic("kfree");
801063fb:	c7 04 24 c6 6f 10 80 	movl   $0x80106fc6,(%esp)
...
80106541:	c3                   	ret    
  ...
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
80106542:	c7 04 24 30 76 10 80 	movl   $0x80107630,(%esp)
...
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
80106651:	c7 04 24 36 76 10 80 	movl   $0x80107636,(%esp)
80106658:	e8 03 9d ff ff       	call   80100360 <panic>
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
8010665d:	c7 04 24 61 76 10 80 	movl   $0x80107661,(%esp)
...
switchuvm(struct proc *p)
{
  ...
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
80106669:	c7 04 24 4c 76 10 80 	movl   $0x8010764c,(%esp)
...
inituvm(pde_t *pgdir, char *init, uint sz)
{
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
801066fe:	c7 04 24 75 76 10 80 	movl   $0x80107675,(%esp)
...
801067b1:	c3                   	ret    
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
801067b2:	c7 04 24 8f 76 10 80 	movl   $0x8010768f,(%esp)
801067b9:	e8 a2 9b ff ff       	call   80100360 <panic>
{
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
801067be:	c7 04 24 30 77 10 80 	movl   $0x80107730,(%esp)
...
801067de:	0f 88 8f 00 00 00    	js     80106873 <allocuvm+0xa3>
    return 0;
  if(newsz < oldsz)
...
801067e7:	8b 45 0c             	mov    0xc(%ebp),%eax
  ...
  if(newsz >= KERNBASE)
    return 0;
  if(newsz < oldsz)
801067ea:	0f 82 85 00 00 00    	jb     80106875 <allocuvm+0xa5>
    return oldsz;
...
80106800:	eb 7e                	jmp    80106880 <allocuvm+0xb0>
...
8010684b:	78 43                	js     80106890 <allocuvm+0xc0>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
80106855:	76 29                	jbe    80106880 <allocuvm+0xb0>
    mem = kalloc();
...
80106860:	75 a6                	jne    80106808 <allocuvm+0x38>
      cprintf("allocuvm out of memory\n");
80106862:	c7 04 24 ad 76 10 80 	movl   $0x801076ad,(%esp)
...
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
{
  ...
  if(newsz >= oldsz)
8010686e:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106871:	77 47                	ja     801068ba <allocuvm+0xea>
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
...
80106875:	83 c4 2c             	add    $0x2c,%esp
80106878:	5b                   	pop    %ebx
80106879:	5e                   	pop    %esi
8010687a:	5f                   	pop    %edi
8010687b:	5d                   	pop    %ebp
...
80106880:	83 c4 2c             	add    $0x2c,%esp
...
8010688a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
80106890:	c7 04 24 c5 76 10 80 	movl   $0x801076c5,(%esp)
...
8010689f:	76 0d                	jbe    801068ae <allocuvm+0xde>
801068a1:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801068a4:	89 fa                	mov    %edi,%edx
801068a6:	8b 45 08             	mov    0x8(%ebp),%eax
801068a9:	e8 c2 fa ff ff       	call   80106370 <deallocuvm.part.0>
    }
    memset(mem, 0, PGSIZE);
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
...
801068b1:	e8 2a ba ff ff       	call   801022e0 <kfree>
      return 0;
801068b6:	31 c0                	xor    %eax,%eax
801068b8:	eb bb                	jmp    80106875 <allocuvm+0xa5>
801068ba:	8b 4d 0c             	mov    0xc(%ebp),%ecx
801068bd:	89 fa                	mov    %edi,%edx
801068bf:	8b 45 08             	mov    0x8(%ebp),%eax
801068c2:	e8 a9 fa ff ff       	call   80106370 <deallocuvm.part.0>
  for(; a < newsz; a += PGSIZE){
    mem = kalloc();
    if(mem == 0){
      cprintf("allocuvm out of memory\n");
...
801068c9:	eb aa                	jmp    80106875 <allocuvm+0xa5>
801068cb:	90                   	nop
...
801068e0:	5d                   	pop    %ebp
801068e1:	e9 8a fa ff ff       	jmp    80106370 <deallocuvm.part.0>
...
8010690a:	e8 61 fa ff ff       	call   80106370 <deallocuvm.part.0>
...
8010693d:	e8 9e b9 ff ff       	call   801022e0 <kfree>
  uint i;
...
80106952:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80106953:	e9 88 b9 ff ff       	jmp    801022e0 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
  ...
  if(pgdir == 0)
    panic("freevm: no pgdir");
80106958:	c7 04 24 e1 76 10 80 	movl   $0x801076e1,(%esp)
...
80106975:	83 ec 20             	sub    $0x20,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80106978:	e8 13 bb ff ff       	call   80102490 <kalloc>
8010697d:	85 c0                	test   %eax,%eax
8010697f:	89 c6                	mov    %eax,%esi
80106981:	74 75                	je     801069f8 <setupkvm+0x88>
    return 0;
...
8010699b:	e8 d0 d8 ff ff       	call   80104270 <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
...
801069a9:	89 54 24 10          	mov    %edx,0x10(%esp)
801069ad:	8b 53 08             	mov    0x8(%ebx),%edx
801069b0:	89 44 24 0c          	mov    %eax,0xc(%esp)
801069b4:	29 c2                	sub    %eax,%edx
801069b6:	8b 03                	mov    (%ebx),%eax
801069b8:	89 54 24 08          	mov    %edx,0x8(%esp)
801069bc:	89 44 24 04          	mov    %eax,0x4(%esp)
801069c0:	e8 0b fb ff ff       	call   801064d0 <mappages>
801069c5:	85 c0                	test   %eax,%eax
801069c7:	78 17                	js     801069e0 <setupkvm+0x70>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
801069c9:	83 c3 10             	add    $0x10,%ebx
801069cc:	81 fb 60 a4 10 80    	cmp    $0x8010a460,%ebx
801069d2:	72 cc                	jb     801069a0 <setupkvm+0x30>
...
801069dd:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
                (uint)k->phys_start, k->perm) < 0) {
      freevm(pgdir);
801069e0:	89 34 24             	mov    %esi,(%esp)
801069e3:	e8 08 ff ff ff       	call   801068f0 <freevm>
      return 0;
    }
  return pgdir;
}
801069e8:	83 c4 20             	add    $0x20,%esp
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
                (uint)k->phys_start, k->perm) < 0) {
...
801069f1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
{
  ...
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
801069f8:	31 c0                	xor    %eax,%eax
801069fa:	eb da                	jmp    801069d6 <setupkvm+0x66>
...
80106a2e:	e8 ad f8 ff ff       	call   801062e0 <walkpgdir>
  if(pte == 0)
...
80106a3b:	c3                   	ret    
{
  ...
  if(pte == 0)
    panic("clearpteu");
80106a3c:	c7 04 24 f2 76 10 80 	movl   $0x801076f2,(%esp)
...
80106a63:	0f 84 7a 01 00 00    	je     80106be3 <copyuvm+0x193>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106a69:	8b 45 0c             	mov    0xc(%ebp),%eax
80106a6c:	85 c0                	test   %eax,%eax
80106a6e:	0f 84 ac 00 00 00    	je     80106b20 <copyuvm+0xd0>
80106a74:	31 db                	xor    %ebx,%ebx
80106a76:	eb 51                	jmp    80106ac9 <copyuvm+0x79>
...
80106a78:	81 c7 00 00 00 80    	add    $0x80000000,%edi
80106a7e:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106a85:	00 
80106a86:	89 7c 24 04          	mov    %edi,0x4(%esp)
80106a8a:	89 04 24             	mov    %eax,(%esp)
80106a8d:	e8 7e d8 ff ff       	call   80104310 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106a92:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106a95:	8d 96 00 00 00 80    	lea    -0x80000000(%esi),%edx
80106a9b:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106a9f:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106aa6:	00 
80106aa7:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106aab:	89 44 24 10          	mov    %eax,0x10(%esp)
80106aaf:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106ab2:	89 04 24             	mov    %eax,(%esp)
80106ab5:	e8 16 fa ff ff       	call   801064d0 <mappages>
80106aba:	85 c0                	test   %eax,%eax
80106abc:	78 4d                	js     80106b0b <copyuvm+0xbb>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106abe:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106ac4:	39 5d 0c             	cmp    %ebx,0xc(%ebp)
80106ac7:	76 57                	jbe    80106b20 <copyuvm+0xd0>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106ac9:	8b 45 08             	mov    0x8(%ebp),%eax
80106acc:	31 c9                	xor    %ecx,%ecx
80106ace:	89 da                	mov    %ebx,%edx
80106ad0:	e8 0b f8 ff ff       	call   801062e0 <walkpgdir>
80106ad5:	85 c0                	test   %eax,%eax
80106ad7:	0f 84 19 01 00 00    	je     80106bf6 <copyuvm+0x1a6>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106add:	8b 30                	mov    (%eax),%esi
80106adf:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106ae5:	0f 84 ff 00 00 00    	je     80106bea <copyuvm+0x19a>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106aeb:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106aed:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106af3:	89 75 e4             	mov    %esi,-0x1c(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106af6:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106afc:	e8 8f b9 ff ff       	call   80102490 <kalloc>
80106b01:	85 c0                	test   %eax,%eax
80106b03:	89 c6                	mov    %eax,%esi
80106b05:	0f 85 6d ff ff ff    	jne    80106a78 <copyuvm+0x28>
      goto bad;
  }
  return d;
...
80106b11:	e8 da fd ff ff       	call   801068f0 <freevm>
  return 0;
...
80106b1f:	c3                   	ret    
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106b20:	bb fc ff ff 7f       	mov    $0x7ffffffc,%ebx
80106b25:	e9 94 00 00 00       	jmp    80106bbe <copyuvm+0x16e>
80106b2a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
      goto bad;
  }
  // literally copy-paste but change the for loop
...
80106b37:	e8 a4 f7 ff ff       	call   801062e0 <walkpgdir>
80106b3c:	85 c0                	test   %eax,%eax
80106b3e:	0f 84 b2 00 00 00    	je     80106bf6 <copyuvm+0x1a6>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106b44:	8b 30                	mov    (%eax),%esi
80106b46:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106b4c:	0f 84 98 00 00 00    	je     80106bea <copyuvm+0x19a>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106b52:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106b54:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106b5a:	89 75 e4             	mov    %esi,-0x1c(%ebp)
  for(i = KERNBASE-4; i > KERNBASE-4-(myproc()->stacksz*PGSIZE); i -= PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106b5d:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106b63:	e8 28 b9 ff ff       	call   80102490 <kalloc>
80106b68:	85 c0                	test   %eax,%eax
80106b6a:	89 c6                	mov    %eax,%esi
80106b6c:	74 9d                	je     80106b0b <copyuvm+0xbb>
      goto bad;
    memmove(mem, (char*)P2V(pa), PGSIZE);
80106b6e:	81 c7 00 00 00 80    	add    $0x80000000,%edi
80106b74:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106b7b:	00 
80106b7c:	89 7c 24 04          	mov    %edi,0x4(%esp)
80106b80:	89 04 24             	mov    %eax,(%esp)
80106b83:	e8 88 d7 ff ff       	call   80104310 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106b88:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106b8b:	8d 96 00 00 00 80    	lea    -0x80000000(%esi),%edx
80106b91:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106b95:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106b9c:	00 
80106b9d:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80106ba1:	89 44 24 10          	mov    %eax,0x10(%esp)
80106ba5:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106ba8:	89 04 24             	mov    %eax,(%esp)
80106bab:	e8 20 f9 ff ff       	call   801064d0 <mappages>
80106bb0:	85 c0                	test   %eax,%eax
80106bb2:	0f 88 53 ff ff ff    	js     80106b0b <copyuvm+0xbb>
    memmove(mem, (char*)P2V(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
      goto bad;
  }
  // literally copy-paste but change the for loop
  for(i = KERNBASE-4; i > KERNBASE-4-(myproc()->stacksz*PGSIZE); i -= PGSIZE){
80106bb8:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80106bbe:	e8 cd ca ff ff       	call   80103690 <myproc>
80106bc3:	b9 fc ff ff 7f       	mov    $0x7ffffffc,%ecx
80106bc8:	8b 40 7c             	mov    0x7c(%eax),%eax
80106bcb:	c1 e0 0c             	shl    $0xc,%eax
80106bce:	29 c1                	sub    %eax,%ecx
80106bd0:	39 cb                	cmp    %ecx,%ebx
80106bd2:	0f 87 58 ff ff ff    	ja     80106b30 <copyuvm+0xe0>
...
80106be5:	e9 2e ff ff ff       	jmp    80106b18 <copyuvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
80106bea:	c7 04 24 16 77 10 80 	movl   $0x80107716,(%esp)
80106bf1:	e8 6a 97 ff ff       	call   80100360 <panic>
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
80106bf6:	c7 04 24 fc 76 10 80 	movl   $0x801076fc,(%esp)
...
80106c1e:	e8 bd f6 ff ff       	call   801062e0 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106ce6:	c7 44 24 04 54 77 10 	movl   $0x80107754,0x4(%esp)
80106ced:	80 
80106cee:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106cf5:	e8 46 d3 ff ff       	call   80104040 <initlock>
  acquire(&(shm_table.lock));
80106cfa:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106d01:	e8 2a d4 ff ff       	call   80104130 <acquire>
80106d06:	b8 f4 55 11 80       	mov    $0x801155f4,%eax
80106d0b:	90                   	nop
80106d0c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for (i = 0; i< 64; i++) {
    shm_table.shm_pages[i].id =0;
80106d10:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80106d16:	83 c0 0c             	add    $0xc,%eax
    shm_table.shm_pages[i].frame =0;
80106d19:	c7 40 f8 00 00 00 00 	movl   $0x0,-0x8(%eax)
    shm_table.shm_pages[i].refcnt =0;
80106d20:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
...
void shminit() {
  ...
  acquire(&(shm_table.lock));
  for (i = 0; i< 64; i++) {
80106d27:	3d f4 58 11 80       	cmp    $0x801158f4,%eax
80106d2c:	75 e2                	jne    80106d10 <shminit+0x30>
    shm_table.shm_pages[i].id =0;
    shm_table.shm_pages[i].frame =0;
    shm_table.shm_pages[i].refcnt =0;
  }
...
80106d35:	e8 e6 d4 ff ff       	call   80104220 <release>
}
80106d3a:	c9                   	leave  
80106d3b:	c3                   	ret    
