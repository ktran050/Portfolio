...
80105283:	e8 b8 1b 00 00       	call   80106e40 <shm_close>
}
80105288:	c9                   	leave  
80105289:	c3                   	ret    
...
int shm_open(int id, char **pointer) {
  uint pageSeen=0;	// flag that an id has been seen
  struct proc *curproc=myproc();
80106d10:	89 c7                	mov    %eax,%edi
  char *mem;
  int i;

  // Loop through the table
  initlock(&(shm_table.lock), "SHM lock");
80106d12:	e8 49 d3 ff ff       	call   80104060 <initlock>
  acquire(&(shm_table.lock));
80106d17:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106d1e:	e8 2d d4 ff ff       	call   80104150 <acquire>
80106d23:	b8 f4 54 11 80       	mov    $0x801154f4,%eax
  for(i = 0; i < 64; i++){
80106d28:	31 d2                	xor    %edx,%edx
80106d2a:	eb 0f                	jmp    80106d3b <shm_open+0x4b>
80106d2c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80106d30:	83 c2 01             	add    $0x1,%edx
80106d33:	83 c0 0c             	add    $0xc,%eax
80106d36:	83 fa 40             	cmp    $0x40,%edx
80106d39:	74 75                	je     80106db0 <shm_open+0xc0>
    if(shm_table.shm_pages[i].id==id){
80106d3b:	39 30                	cmp    %esi,(%eax)
80106d3d:	75 f1                	jne    80106d30 <shm_open+0x40>
      // Set flag
      pageSeen=1;
      // Increment counter
      shm_table.shm_pages[i].refcnt+=1;
80106d3f:	8d 04 52             	lea    (%edx,%edx,2),%eax
80106d42:	c1 e0 02             	shl    $0x2,%eax
80106d45:	83 80 fc 54 11 80 01 	addl   $0x1,-0x7feeab04(%eax)
      // Map the page
...
80106d4c:	8b 80 f8 54 11 80    	mov    -0x7feeab08(%eax),%eax
80106d52:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106d59:	00 
80106d5a:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106d61:	00 
80106d62:	05 00 00 00 80       	add    $0x80000000,%eax
80106d67:	89 44 24 0c          	mov    %eax,0xc(%esp)
80106d6b:	8b 07                	mov    (%edi),%eax
80106d6d:	05 ff 0f 00 00       	add    $0xfff,%eax
80106d72:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106d77:	89 44 24 04          	mov    %eax,0x4(%esp)
80106d7b:	8b 47 04             	mov    0x4(%edi),%eax
80106d7e:	89 04 24             	mov    %eax,(%esp)
80106d81:	e8 ca f7 ff ff       	call   80106550 <mappages>
      // Return pointer to virtual address
      *pointer=(char *)(curproc->sz);
80106d86:	8b 07                	mov    (%edi),%eax
80106d88:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106d8b:	89 01                	mov    %eax,(%ecx)
      // Update size to reflect changes
      curproc->sz+=PGSIZE;
80106d8d:	81 07 00 10 00 00    	addl   $0x1000,(%edi)
      // Release lock
      release(&(shm_table.lock));
80106d93:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106d9a:	e8 a1 d4 ff ff       	call   80104240 <release>
    }
  }
  // Release lock
  release(&(shm_table.lock));
...
80106da9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  acquire(&(shm_table.lock));
  for(i = 0; i < 64; i++){
80106db0:	bb f4 54 11 80       	mov    $0x801154f4,%ebx
80106db5:	eb 0c                	jmp    80106dc3 <shm_open+0xd3>
80106db7:	90                   	nop
80106db8:	83 c3 0c             	add    $0xc,%ebx
  }
  ...
  if(pageSeen==0){
    ...
    for(i=0; i < 64; i++){
80106dbb:	81 fb f4 57 11 80    	cmp    $0x801157f4,%ebx
80106dc1:	74 63                	je     80106e26 <shm_open+0x136>
      if(shm_table.shm_pages[i].id==0){
80106dc3:	8b 03                	mov    (%ebx),%eax
80106dc5:	85 c0                	test   %eax,%eax
80106dc7:	75 ef                	jne    80106db8 <shm_open+0xc8>
        // Set id
        shm_table.shm_pages[i].id=id;
80106dc9:	89 33                	mov    %esi,(%ebx)
80106dcb:	83 c3 0c             	add    $0xc,%ebx
	// Allocate a page
	mem=kalloc();
80106dce:	e8 dd b6 ff ff       	call   801024b0 <kalloc>
        // Set frame
        shm_table.shm_pages[i].frame=mem;
        // Increment page count
        shm_table.shm_pages[i].refcnt=1;
80106dd3:	c7 43 fc 01 00 00 00 	movl   $0x1,-0x4(%ebx)
        // Map the page
        mappages(curproc->pgdir, (char*)(PGROUNDUP(curproc->sz)), PGSIZE, V2P(mem), PTE_W|PTE_U);
80106dda:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106de1:	00 
...
80106de9:	00 
	...
	mem=kalloc();
        // Set frame
        shm_table.shm_pages[i].frame=mem;
80106dea:	89 43 f8             	mov    %eax,-0x8(%ebx)
        // Increment page count
        shm_table.shm_pages[i].refcnt=1;
        // Map the page
        mappages(curproc->pgdir, (char*)(PGROUNDUP(curproc->sz)), PGSIZE, V2P(mem), PTE_W|PTE_U);
80106ded:	05 00 00 00 80       	add    $0x80000000,%eax
80106df2:	89 44 24 0c          	mov    %eax,0xc(%esp)
80106df6:	8b 07                	mov    (%edi),%eax
80106df8:	05 ff 0f 00 00       	add    $0xfff,%eax
80106dfd:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106e02:	89 44 24 04          	mov    %eax,0x4(%esp)
80106e06:	8b 47 04             	mov    0x4(%edi),%eax
80106e09:	89 04 24             	mov    %eax,(%esp)
80106e0c:	e8 3f f7 ff ff       	call   80106550 <mappages>
        // Return pointer to virtual address
        *pointer=(char*)(curproc->sz);
80106e11:	8b 07                	mov    (%edi),%eax
80106e13:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106e16:	89 01                	mov    %eax,(%ecx)
        // Increment the size
        curproc->sz+=PGSIZE;
80106e18:	81 07 00 10 00 00    	addl   $0x1000,(%edi)
  }
  ...
  if(pageSeen==0){
    // Loop through the table for the next available entry
    for(i=0; i < 64; i++){
80106e1e:	81 fb f4 57 11 80    	cmp    $0x801157f4,%ebx
80106e24:	75 9d                	jne    80106dc3 <shm_open+0xd3>
        curproc->sz+=PGSIZE;
      }
    }
  }
  // Release lock
  release(&(shm_table.lock));
80106e26:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106e2d:	e8 0e d4 ff ff       	call   80104240 <release>
  return 0; //added to remove compiler warning -- you should decide what to return
}
80106e32:	83 c4 2c             	add    $0x2c,%esp
80106e35:	31 c0                	xor    %eax,%eax
80106e37:	5b                   	pop    %ebx
80106e38:	5e                   	pop    %esi
80106e39:	5f                   	pop    %edi
80106e3a:	5d                   	pop    %ebp
...
80106e44:	83 ec 14             	sub    $0x14,%esp
80106e47:	8b 5d 08             	mov    0x8(%ebp),%ebx
  int i;

  initlock(&(shm_table.lock), "SHM lock");
80106e4a:	c7 44 24 04 d4 78 10 	movl   $0x801078d4,0x4(%esp)
80106e51:	80 
80106e52:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106e59:	e8 02 d2 ff ff       	call   80104060 <initlock>
  acquire(&(shm_table.lock));
80106e5e:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106e65:	e8 e6 d2 ff ff       	call   80104150 <acquire>
80106e6a:	b8 f4 54 11 80       	mov    $0x801154f4,%eax
80106e6f:	eb 11                	jmp    80106e82 <shm_close+0x42>
80106e71:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80106e78:	83 c0 0c             	add    $0xc,%eax
  // Loop through the table looking for the id
  for(i=0; i <64; i++){
80106e7b:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80106e80:	74 2e                	je     80106eb0 <shm_close+0x70>
    if(shm_table.shm_pages[i].id==id){
80106e82:	3b 18                	cmp    (%eax),%ebx
80106e84:	75 f2                	jne    80106e78 <shm_close+0x38>
      // Decrease reference count
      shm_table.shm_pages[i].refcnt-=1;
80106e86:	8b 48 08             	mov    0x8(%eax),%ecx
80106e89:	8d 51 ff             	lea    -0x1(%ecx),%edx
      // if refcnt is now empty clear the entry
      if(shm_table.shm_pages[i].refcnt==0){
80106e8c:	85 d2                	test   %edx,%edx
  acquire(&(shm_table.lock));
  // Loop through the table looking for the id
  for(i=0; i <64; i++){
    if(shm_table.shm_pages[i].id==id){
      // Decrease reference count
      shm_table.shm_pages[i].refcnt-=1;
80106e8e:	89 50 08             	mov    %edx,0x8(%eax)
      // if refcnt is now empty clear the entry
      if(shm_table.shm_pages[i].refcnt==0){
80106e91:	75 e5                	jne    80106e78 <shm_close+0x38>
        shm_table.shm_pages[i].id=0;
80106e93:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80106e99:	83 c0 0c             	add    $0xc,%eax
        shm_table.shm_pages[i].frame=0;	// refcount is already 0; no need to set it again
80106e9c:	c7 40 f8 00 00 00 00 	movl   $0x0,-0x8(%eax)
  int i;
  ...
  // Loop through the table looking for the id
  for(i=0; i <64; i++){
80106ea3:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80106ea8:	75 d8                	jne    80106e82 <shm_close+0x42>
80106eaa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  ...
  release(&(shm_table.lock));
80106eb0:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106eb7:	e8 84 d3 ff ff       	call   80104240 <release>
  return 0; //added to remove compiler warning -- you should decide what to return
}
80106ebc:	83 c4 14             	add    $0x14,%esp
