...
void application::draw_scene(float time_elapsed) 
{
    ...
    // Yellow Sphere 
    float yellow_angular_speed=-150;
    glPushMatrix();
    	glRotatef(time_elapsed*yellow_angular_speed,0,1,0);
    	glTranslatef(2,0,0);
    	glColor3f(1, 1, 0);
    	draw_sphere(0.5);
    glPopMatrix();
    ...
    // Cyan Dodecahedron 
    float cyan_angular_speed=20;
    	glRotatef(time_elapsed*cyan_angular_speed,0,1,0);
    	glTranslatef(8,0,0);
    	glScalef(0.5, 0.5, 0.5);
    	glColor3f(0, 1, 1);
    	draw_dodecadron();
 	glScalef(2,2,2); // undo cyan scaling
    
    // Green Sphere
    float green_angular_speed=300;
    glPushMatrix();
	// undo cyan scaling
    	glRotatef(time_elapsed*green_angular_speed,1,0,0);
    	glTranslatef(0, 2, 0);
    	glColor3f(0, 1, 0);
    	draw_sphere(0.2);
    glPopMatrix();
    ...
    // Purple Box
    float purple_angular_speed=100;
    	glRotatef(time_elapsed*purple_angular_speed,0,1,0);
    	glTranslatef(4, 0, 0);
    	glScalef(0.5, 2, 0.5);
    	glColor3f(1, 0, 1);
    	draw_unit_cube();
        glScalef(2, 0.5, 2); // undo purple scaling

    // Red Dodecahedron
    float red_angular_speed=350;
    	glRotatef(time_elapsed*red_angular_speed,0,1,0);
    	glTranslatef(1, 0, 0);
